...
<div>
	<form class="form-horizontal" role="form" name="categoryForm" novalidate>
		<div>
			...
			<div>
				<div >
					<input type="text" class="form-control" id="name" name="name" ng-model="subcategoryInfo.name"  placeholder="Write Category Name">
				</div>
			</div>
		</div>
		...
		<div>
			...
			<div>
				<div >
					<input type="text" class="form-control" id="details" name="details" ng-model="subcategoryInfo.details"  placeholder="Write Category Details">
				</div>
			</div>
		</div>
		<br><br>
