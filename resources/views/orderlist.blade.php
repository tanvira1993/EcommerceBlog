...
<table class="table table-dark">
	...
	<tbody>
		...
		<tr scope="row" ng-repeat="(key, value) in fileInfo | filter:{id_order_list: search.id_order_list, user_name: search.user_name, user_address: search.user_address, user_phone_no: search.user_phone_no}">
			...
			<td> <a target="_blank" href="/order/billSlip/@{{value.id_order_list}}" class="btn btn-primary"> Bill Slip</a><a ng-click="deliveryQueue(value.id_order_list)" class="btn btn-info"> Delivery Progress</a></td>
